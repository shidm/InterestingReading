...
public class AudioFragment extends Fragment implements IAudioFragment {
    ...
    private void init() {
        ...
        adapter = new RecyclerAdapter<AudioEntity>(getContext(), list, "声音", this);

        jumpFirstBtn = view.findViewById(R.id.audio_jump_First);
        ...
        presenter.getAudioData(String.valueOf(page));
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (layoutManager instanceof LinearLayoutManager) {
                    ...
                    if (lastItemPosition >= refrushPosition) {
                        p.getAudioData(String.valueOf(++page));
                    }
                }
            }
