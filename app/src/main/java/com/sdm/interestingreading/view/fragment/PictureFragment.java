...
public class PictureFragment extends Fragment implements IPictureFragment{
    ...
    private List<PictureEntity> list = new ArrayList();
    ...
    private void init() {
        ...
        adapter = new RecyclerAdapter<PictureEntity>(getContext(), list, "图片", this);

        jumpFirstBtn = view.findViewById(R.id.picture_jump_First);
        ...
        recyclerView = view.findViewById(R.id.picture_recycler);
        ...
        presenter.getPictureData(String.valueOf(page));
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (layoutManager instanceof LinearLayoutManager) {
                    ...
                    if (lastItemPosition >= refrushPosition) {
                        p.getPictureData(String.valueOf(++page));
                    }
                }
            }
    ...
    @Override
    public void showDetailPicture(PictureEntity pictureEntity) {
        fragment = PictureDetailFragment.newInstance(pictureEntity);
